...
RSpec.describe 'admin_merchants_index', type: :feature do
  ...
  describe 'I see the names of the top 5 merchants by total revenue generated' do
    before(:each) do
      ...
      @merchant_item_3 = create(:item, merchant_id: @merchant_3.id, unit_price: 10_000)
      @merchant_item_4 = create(:item, merchant_id: @merchant_4.id, unit_price: 10_000)
      @merchant_item_5 = create(:item, merchant_id: @merchant_5.id, unit_price: 10_000)
      @merchant_item_6 = create(:item, merchant_id: @merchant_6.id, unit_price: 10_000)
      @merchant_item_7 = create(:item, merchant_id: @merchant_7.id, unit_price: 10_000)
